...
class Admin_bot():
    def __init__(self, token:str):
        ...
        self.bot.message_handler(func=lambda message: self.waiting_for_button)(self.warn_user_to_press_button)
    ...
    def warn_user_to_press_button(self, message):
        self.bot.send_message(message.chat.id, "Пожалуйста, нажмите одну из кнопок: 'Сдал' или 'Не пришел', прежде чем продолжить.")
